...
export const CommandCenter: React.FC = () => {
  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-[1100] h-14 border-b border-emerald-500/20 bg-[#020202]/90 backdrop-blur-md px-6 flex items-center justify-between">
      {/* Platform Branding */}
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-lg font-black tracking-tighter text-white leading-none">Vortex</h1>
